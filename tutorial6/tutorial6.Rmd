...
- How can we model an RDD setting?
- We want to look for a jump at a cutoff point
- Get as good an idea as posible of what the outcome is just on either side of the cutoff
- So...
...
- This is of course the simplest version of the specification!

- Things to consider:
- Non-parametric specification
  - Bandwidth choice
- Functional form (polynomial estimation)
...
- Imbens and Gelman (2018) show that the "naive" RDD estimators place heigh weights on observations far from the threshold
- So... it's better to drop 'em!
...
- Let's look at `help(rdrobust, package = 'rdrobust')`
